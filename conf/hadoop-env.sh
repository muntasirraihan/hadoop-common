...
# (bcho2) Added for use of /bin/hdfs dfs -text when using Jimmy Lin Cloud9
# export HADOOP_CLASSPATH=$HADOOP_CLASSPATH:/home/bcho2/hadoop-0.23.3-SNAPSHOT/cloud9-bcho2.jar
