...
import org.apache.hadoop.mapreduce.v2.proto.MRServiceProtos.SuspendTaskAttemptRequestProtoOrBuilder;
import org.apache.hadoop.yarn.api.records.ProtoBase;


    
public class SuspendTaskAttemptRequestPBImpl extends ProtoBase<SuspendTaskAttemptRequestProto> implements SuspendTaskAttemptRequest {
  SuspendTaskAttemptRequestProto proto = SuspendTaskAttemptRequestProto.getDefaultInstance();
  SuspendTaskAttemptRequestProto.Builder builder = null;
  boolean viaProto = false;
  
  private TaskAttemptId taskAttemptId = null;
  
  
  public SuspendTaskAttemptRequestPBImpl() {
    builder = SuspendTaskAttemptRequestProto.newBuilder();
  }

  public SuspendTaskAttemptRequestPBImpl(SuspendTaskAttemptRequestProto proto) {
    this.proto = proto;
    viaProto = true;
  }
  
  public SuspendTaskAttemptRequestProto getProto() {
      mergeLocalToProto();
  ...
  private void maybeInitBuilder() {
    if (viaProto || builder == null) {
      builder = SuspendTaskAttemptRequestProto.newBuilder(proto);
    }
    viaProto = false;
  }
  ...
  public TaskAttemptId getTaskAttemptId() {
    SuspendTaskAttemptRequestProtoOrBuilder p = viaProto ? proto : builder;
    if (this.taskAttemptId != null) {
